			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<button class="btn btn-info" data-toggle="modal" data-target="#pass">Change Password Admin</button>
							<button class="btn btn-warning float-right" data-toggle="modal" data-target="#edit">Edit Data Toko</button>
						</div>
					</div>
				</div>
			</div>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form action="<?= site_url('profil/ubah') ?>" method="post">
				<div class="modal-body">
					<input type="hidden" name="id" value="<?= $this->session->userdata('id') ?>">
					<div class="form-group row">
						<label for="nama" class="col-4">Nama Toko</label>
						<div class="col-8">
					...
					<div class="form-group row">
						<label for="hp" class="col-4">No Telpon</label>
						<div class="col-8">
